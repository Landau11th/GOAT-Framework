...
//some naive approach to find maximum on 1D
template<typename real>
...
template class Quasi_Newton<float>;
template class Quasi_Newton<double>;

template<typename real>
arma::Col<real> Quasi_Newton<real>::BFGS(arma::Col<real> start_coordinate) const
{
